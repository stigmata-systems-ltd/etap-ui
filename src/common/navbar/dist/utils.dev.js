...
exports.metaDataNavbar = exports.getNavbar = void 0;
...
var getNavbar = function getNavbar() {
  var auth = _store["default"].getState().auth;

  var tmpArr = [];
  auth.pageAccess && auth.pageAccess.map(function (item) {});
};
...
exports.metaDataNavbar = metaDataNavbar;